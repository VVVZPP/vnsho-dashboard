...
Respond without markdown. Be concise. Warm, helpful tone.`;
 ...
 if (typeof window !== 'undefined' && window.location.pathname === '/embed/brand-rankings-full') {
  ...
  // ============ STANDALONE EMBED: /embed/ev-population ============
  // Also answers the legacy /embed/fleet-breakdown path so any existing Wix embed keeps working.
  if (typeof window !== 'undefined' && (window.location.pathname === '/embed/ev-population' || window.location.pathname === '/embed/fleet-breakdown')) {
    const POP_FUELS = [
